...
var getScrollableParent = (element) => {
  ...
  const isConstrainedByLayout = (el, dimension) => {
    const parent22 = el.parentElement;
    if (!parent22) {
      return false;
    }
    const parentStyle = window.getComputedStyle(parent22);
...
var requestFingerprintResolver = (config3, axios) => `${config3.method}:${config3.baseURL ?? axios.defaults.baseURL ?? ""}${config3.url}`;
var successResolver = (response) => response.status === 204 && response.headers["precognition-success"] === "true";
var abortControllers = {};
var client = {
  get: (url, data = {}, config3 = {}) => request(mergeConfig2("get", url, data, config3)),
  post: (url, data = {}, config3 = {}) => request(mergeConfig2("post", url, data, config3)),
  patch: (url, data = {}, config3 = {}) => request(mergeConfig2("patch", url, data, config3)),
  put: (url, data = {}, config3 = {}) => request(mergeConfig2("put", url, data, config3)),
  delete: (url, data = {}, config3 = {}) => request(mergeConfig2("delete", url, data, config3)),
  use(axios) {
    axiosClient = axios;
    return client;
  },
...
var mergeConfig2 = (method2, url, data, config3) => ({
  url,
  method: method2,
  ...config3,
...
var hasFiles2 = (data) => isFile2(data) || typeof data === "object" && data !== null && Object.values(data).some((value) => hasFiles2(value));
...
var createValidator = (callback, initialData = {}) => {
  ...
  const validate = (name, value, config3) => {
    ...
    if (isFile2(value) && !validateFiles) {
...
function useForm(...args) {
  ...
  const [data, setData2] = rememberKey ? useRemember(defaults2, `${rememberKey}:data`, excludeKeysRef) : (0, import_react9.useState)(defaults2);
  ...
  const isDirty = (0, import_react9.useMemo)(() => !isEqual_default(data, defaults2), [data, defaults2]);
