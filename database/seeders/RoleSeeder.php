...
class RoleSeeder extends Seeder
{
    ...
    private function getCompanyPermissions(): array
    {
        $basePermissions = [
            ...
            // Noc Template Permissions
            'manage-noc',
            'update-noc',

            // Joining Letter Template Permissions
            'manage-joining-letter',
            'update-joining-letter',

            // Experience Certificate Template Permissions
            'manage-experience-certificate',
            ...
            // Payroll Entries Permission
            'delete-payroll-entries',

            // Employee Import/Export Permissions
            'import-employee',
            'export-employee',
