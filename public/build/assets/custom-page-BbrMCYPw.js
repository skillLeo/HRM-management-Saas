import{R,j as o}from"./ui-DU6W5RP9.js";import{c as z,H as A}from"./app-DMJvopwv.js";import F from"./Header-CCtfEOA6.js";import T from"./Footer-S5nDr-28.js";import{u as $}from"./use-favicon-CW5XpY7F.js";import"./utils-BWxnHGCV.js";import"./menu-F_EBf_n8.js";import"./mail-2RatxhWR.js";import"./phone-yX-SefMJ.js";import"./map-pin-AWnWAuyG.js";import"./instagram-C9Ik9Fhp.js";import"./twitter-CL-TETr8.js";function X(){var u,f,h,x,g,b,y,j,_,v,C,N,k;const l=z(),{page:t,customPages:P=[],settings:e}=l.props,n=l.props.globalSettings;R.useEffect(()=>{const r=(n==null?void 0:n.is_demo)||!1;let c="left";if(r){const m=(H=>{var E;if(typeof document>"u")return null;const w=`; ${document.cookie}`.split(`; ${H}=`);if(w.length===2){const D=(E=w.pop())==null?void 0:E.split(";").shift();return D?decodeURIComponent(D):null}return null})("layoutPosition");(m==="left"||m==="right")&&(c=m)}else{const s=n==null?void 0:n.layoutDirection;(s==="left"||s==="right")&&(c=s)}const i=c==="right"?"rtl":"ltr";document.documentElement.dir=i,document.documentElement.setAttribute("dir",i),setTimeout(()=>{document.documentElement.getAttribute("dir")!==i&&(document.documentElement.dir=i,document.documentElement.setAttribute("dir",i))},1)},[]);const I=`
